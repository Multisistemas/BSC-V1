    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_sliderb.$ScaleWidth(Math.min(parentWidth, 750));
                else
...
?>
<br />
<center><table id='Exportar_a_Excel'><tr><td><?php if ($idarea==4) { ?><img src="images/arearecursoshumanos.png"><?php } else {if ($idarea==3) { ?><img src="images/areaalmacen.png"><?php } else {if ($idarea==5) { ?>    <div id="sliderb_container" style="position: relative; width: 1024px;
        height: 768px; overflow: hidden;">
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1024px; height: 768px;
            overflow: hidden;">
            <div>
                <img u=image src="images/areaalmacen.png" />
                <div u="thumb">Mapa Estrat&eacute;gico &Aacute;rea Almac&eacute;n</div>
            </div>
            <div>
                <img u=image src="images/areaoperaciones.png" />
                <div u="thumb">Mapa Estrat&eacute;gico &Aacute;rea Operaciones</div>
            </div>
            <div>
                <img u=image src="images/arearecursoshumanos.png" />
                <div u="thumb">Mapa Estrat&eacute;gico &Aacute;rea Recursos Humanos</div>
            </div>
        </div>
        ...
        <style>
            ...
            */
            .jssorb01 div, .jssorb01 div:hover, .jssorb01 .av
            {
                ...
                overflow:hidden;
                cursor: pointer;
                border: #053C73 1px solid;
            }
            .jssorb01 div { background-color: gray; }
            .jssorb01 div:hover, .jssorb01 .av:hover { background-color: #053C73; }
