          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="#"><i class="fa fa-circle-o"></i> Cuadro de Mando</a>
				<ul class="treeview-menu">
				<?php if($_SESSION['id_area']==5) { ?>
                <li class="active"><a href="<?php echo $CFG->wwwroot;?>/perspectivas/pgenerala"><i class="fa fa-circle-o"></i> Almac&eacute;n</a></li>
				<li><a href="<?php echo $CFG->wwwroot;?>/perspectivas/pgeneralo"><i class="fa fa-circle-o"></i> Operaciones</a></li>
				<li><a href="<?php echo $CFG->wwwroot;?>/perspectivas/pgeneralrh"><i class="fa fa-circle-o"></i> Recursos Humanos</a></li>
				<li><a href="<?php echo $CFG->wwwroot;?>/perspectivas/pgeneral"><i class="fa fa-circle-o"></i> Perspectiva General</a></li>
				<?php } else {if($_SESSION['id_area']==3){ ?>
				<li class="active"><a href="<?php echo $CFG->wwwroot;?>/perspectivas/pgenerala"><i class="fa fa-circle-o"></i> Almac&eacute;n</a></li>
   ...
   <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Perspectiva &Aacute;rea Almac&eacute;n
          </h1>
          <ol class="breadcrumb">
