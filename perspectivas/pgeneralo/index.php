          ...
          <ul class="sidebar-menu">
            ...
            <li class="active treeview">
              ...
              <ul class="treeview-menu">
				...
				<ul class="treeview-menu">
				<?php if($_SESSION['id_area']==5) { ?>
                <li><a href="../../perspectivas/pgenerala"><i class="fa fa-circle-o"></i> Almac&eacute;n</a></li>
				<li class="active"><a href="../../perspectivas/pgeneralo"><i class="fa fa-circle-o"></i> Operaciones</a></li>
				<li><a href="../../perspectivas/pgeneralrh"><i class="fa fa-circle-o"></i> Recursos Humanos</a></li>
				<li><a href="../../perspectivas/pgeneral"><i class="fa fa-circle-o"></i> Perspectiva General</a></li>
				<?php } else {if($_SESSION['id_area']==3){ ?>
