...
<html>
  <head>
	...
	<script src="../js/myjavaarea.js"></script>
  </head>
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
				...
				<li class="active"><a href="<?php echo $CFG->wwwroot;?>/registros/area"><i class="fa fa-circle-o"></i> Area</a></li>
   ...
   <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Mantenimiento de Area</li>
          </ol>
        </section>
    ...
    <table border="0" align="center" class="table table-striped table-condensed table-hover">
    	<tr>
        	<td width="555"><input type="text" class="form-control" placeholder="Busca un area por: Nombre" id="busca"/></td>
            <td width="100"><button id="nuevo-area" class="btn btn-primary form-control">Nuevo Registro</button></td>
        </tr>
    </table>
    </section>
...
function valida(e) {
    ...
    <div class="modal fade" id="registra-area" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>Registra o Edita un Area</b></h4>
            </div>
            ...
            <div class="modal-body">
				<table border="0" width="100%">
                	...
                	<tr>
                    	<td>Area: </td>
                        <td><input type="text" required="required" name="area" id="area" maxlength="100" class="form-control" onKeyPress="return valida(event)"/></td>
                    </tr>
                    <tr>
                    	<td colspan="2">
                        	<div id="mensaje"></div>
