          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
				<table border="0" width="100%">
                	...
                	<tr>
                    	<td>NIT: </td>
                        <td><input type="text" required="required" name="nit" id="nit" maxlength="17" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Razon Social: </td>
                        <td><input type="text" required="required" name="rsocial" id="rsocial" maxlength="255" class="form-control"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Direcci&oacute;n: </td>
                        <td><input type="text" required="required" name="direccion" id="direccion" maxlength="255" class="form-control"/>								</td>
                    </tr>
					                	<tr>
