...
<html>
  <head>
	...
	<script src="../js/myjavaempresa.js"></script>
  </head>
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
			  	<li class="active"><a href="<?php echo $CFG->wwwroot;?>/registros/empresa"><i class="fa fa-circle-o"></i> Empresa</a></li>
   ...
   <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Mantenimiento de empresa</li>
          </ol>
        </section>
    ...
    <table border="0" align="center" class="table table-striped table-condensed table-hover">
    	<tr>
        	<td width="555"><input type="text" class="form-control" placeholder="Busca un empresa por: Razon Social" id="busca"/></td>
            <td width="100"><button id="nuevo-empresa" class="btn btn-primary form-control">Nuevo Registro</button></td>
        </tr>
    </table>
    </section>
   <div class="table-responsive mailbox-messages"> <div class="registros" id="agrega-registros"></div></div>
    ...
    <div class="modal fade" id="registra-empresa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>Registra o Edita un empresa</b></h4>
            </div>
