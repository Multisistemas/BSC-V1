...
$(function(){
	...
	$('#agregar').on('click',function(){
		...
		var url = '../compras/agrega_producto.php';
		if (idpro>0){
		$.ajax({
		type:'POST',
		url:url,
	...
	$('#cancelarventa').on('click',function(){
		var url = '../compras/cancelar_venta.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'idpro='+idpro,
	...
	$('#busca').on('keyup',function(){
		var dato = $('#busca').val();
		var url = '../compras/busca_producto.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function agregaRegistro(){
	var url = '../compras/registrar_venta.php';
	if ($('#idpersona').val()>0){
	$.ajax({
		type:'POST',
		url:url,
	...
	{alert("Seleccione Proveedor"); $('#idpersona').focus();}
return false;
}

function eliminarproducto(id){
	var url = '../compras/elimina_producto.php';
...
function actualizarproducto(id,val){
	var url = '../compras/actualizar_producto.php';
...
function pagination(partida){
	var url = '../compras/paginarventas.php';
	$.ajax({
		type:'POST',
		url:url,
