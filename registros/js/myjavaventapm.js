...
$(function(){
	...
	$('#agregar').on('click',function(){
		...
		var url = '../ventaxmayor/agrega_producto.php';
		if (idpro>0){
		$.ajax({
		type:'POST',
		url:url,
	...
	$('#cancelarventa').on('click',function(){
		var url = '../ventaxmayor/cancelar_venta.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'idpro='+idpro,
	...
	$('#busca').on('keyup',function(){
		var dato = $('#busca').val();
		var url = '../ventaxmayor/busca_producto.php';
		$.ajax({
		type:'POST',
		url:url,
		data:'dato='+dato,
...
function agregaRegistro(){
	var url = '../ventaxmayor/registrar_venta.php';
	if ($('#idpersona').val()>0){
	$.ajax({
		type:'POST',
		url:url,
...
function eliminarproducto(id){
	var url = '../ventaxmayor/elimina_producto.php';
...
function actualizarproducto(id,val){
	var url = '../ventaxmayor/actualizar_producto.php';
...
function pagination(partida){
	var url = '../ventaxmayor/paginarventas.php';
	$.ajax({
		type:'POST',
		url:url,
