...
<html>
  <head>
	...
	<script src="../js/myjavapersona.js"></script>
  </head>
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
				...
				<li class="active"><a href="<?php echo $CFG->wwwroot;?>/registros/persona"><i class="fa fa-circle-o"></i> Cliente / Proveedor</a></li>
   ...
   <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Mantenimiento de Persona</li>
          </ol>
        </section>
    ...
    <table border="0" align="center" class="table table-striped table-condensed table-hover">
    	<tr>
        	<td width="555"><input type="text" class="form-control" placeholder="Busca un persona por: Razon Social" id="busca"/></td>
            <td width="100"><button id="nuevo-persona" class="btn btn-primary form-control">Nuevo Registro</button></td>
        </tr>
    </table>
    </section>
   ...
   <div class="table-responsive mailbox-messages"> <div class="registros" id="agrega-registros"></div></div>
    ...
    <div class="modal fade" id="registra-persona" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>Registra o Edita un persona</b></h4>
            </div>
				...
				<table border="0" width="100%">
                	...
                	<tr>
                        ...
                        <td><input type="text" required="required" name="ruc" id="ruc" maxlength="11" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/>								</td>
					                	...
					                	<tr>
                    	<td>Razon Social: </td>
                        <td><input type="text" required="required" name="rsocial" id="rsocial" maxlength="100" class="form-control"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Direcci&oacute;n: </td>
                        <td><input type="text" required="required" name="direccion" id="direccion" maxlength="100" class="form-control"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Tel&eacute;fono: </td>
                        <td><input type="text" required="required" name="telefono" id="telefono" maxlength="100" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/>								</td>
                    </tr>
					<tr>
                    	<td>Celular: </td>
                        <td><input type="text" required="required" name="celular" id="celular" maxlength="100" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/>								</td>
                    </tr>
					<tr>
                    	<td>E-mail: </td>
                        <td><input type="email" required="required" name="correo" id="correo" maxlength="100" class="form-control"/>								</td>
                    </tr>
					<tr>
                    	<td>Tipo: </td>
                        <td><?php llenarcombo('tipopersona','idtipopersona, tipopersona',' ORDER BY 2', $idtipopersona, '','idtipopersona'); ?>								</td>
                    </tr>
                    <tr>
                    	<td colspan="2">
                        	<div id="mensaje"></div>
