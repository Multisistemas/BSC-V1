...
$idempresa = $_SESSION['id_empresa'];
    ...
    $nroProductos = mysql_num_rows(mysql_query("SELECT * FROM persona p,tipopersona tp where p.idtipopersona=tp.idtipopersona and idempresa='$idempresa'"));
    $nroLotes = 15;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysql_query("SELECT * FROM persona p,tipopersona tp where p.idtipopersona=tp.idtipopersona and idempresa='$idempresa' LIMIT $limit, $nroLotes ");
