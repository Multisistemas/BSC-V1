...
switch($proceso){
	case 'Registro':
		mysql_query("INSERT INTO producto (producto,preciocompra,precioventa,precioventau,stock,color,referencia,idcategoria,idalmacen,idempresa)VALUES('$producto','$precioc','$preciov','$preciovu','$stock','$color','$ref','$idcategoria','$idalmacen','$idempresa')");
	break;
	
	case 'Edicion':
		mysql_query("UPDATE producto SET producto = '$producto', preciocompra='$precioc',precioventa='$preciov',precioventau='$preciovu',stock='$stock',color='$color',referencia='$ref',idcategoria='$idcategoria',idalmacen='$idalmacen' WHERE idproducto = '$id'");
	break;
}
