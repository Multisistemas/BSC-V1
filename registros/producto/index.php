          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
				...
				<li class="active"><a href="../../registros/producto"><i class="fa fa-circle-o"></i> Producto</a></li>
			...
			<li class="treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
                ...
                <li class="active"><a href="../../registros/compras"><i class="fa fa-circle-o"></i> Registrar Compras</a></li>
