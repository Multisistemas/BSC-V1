...
<html>
  <head>
	...
	<script src="../js/myjavaproducto.js"></script>
  </head>
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
				...
				<li class="active"><a href="<?php echo $CFG->wwwroot;?>/registros/producto"><i class="fa fa-circle-o"></i> Producto</a></li>
			...
			<li class="treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
                ...
                <li class="active"><a href="<?php echo $CFG->wwwroot;?>/registros/compras"><i class="fa fa-circle-o"></i> Registrar Compras</a></li>
   ...
   <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Mantenimiento de Producto</li>
          </ol>
        </section>
    ...
    <table border="0" align="center" class="table table-striped table-condensed table-hover">
    	<tr>
        	<td width="555"><input type="text" class="form-control" placeholder="Busca un producto por: Nombre" id="busca"/></td>
            <td width="100"><button id="nuevo-producto" class="btn btn-primary form-control">Nuevo Registro</button></td>
        </tr>
    </table>
    </section>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
				<table border="0" width="100%">
                	...
                	<tr>
                    	<td>Producto: </td>
                        <td><input type="text" required="required" name="producto" id="producto" maxlength="100" class="form-control"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Precio Compra: </td>
                        <td><input type="text" required="required" name="precioc" id="precioc" maxlength="50" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Precio Venta: </td>
                        <td><input type="text" required="required" name="preciov" id="preciov" maxlength="50" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Precio Venta Unitario: </td>
                        <td><input type="text" required="required" name="preciovu" id="preciovu" maxlength="50" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Stock: </td>
                        <td><input type="text" required="required" name="stock" id="stock" maxlength="50" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/>								</td>
                    </tr>
					<tr>
                    	<td>Color: </td>
                        <td><input type="text" required="required" name="color" id="color" maxlength="50" class="form-control" onKeyPress="return valida(event)"/>								</td>
                    </tr>
					<tr>
                    	<td>Referencia: </td>
                        <td><input type="text" name="ref" id="ref" maxlength="100" class="form-control"/>								</td>
                    </tr>
					<tr>
                    	<td>Categoria: </td>
                        <td><?php llenarcombo('categoria','idcategoria, categoria',' ORDER BY 2', $idcategoria, '','idcategoria'); ?>								</td>
                    </tr>
					<tr>
                    	<td>Almacen: </td>
                        <td><?php llenarcombo('almacen','idalmacen, almacen',' ORDER BY 2', $idalmacen, '','idalmacen'); ?>								</td>
                    </tr>
                    <tr>
                    	<td colspan="2">
                        	<div id="mensaje"></div>
