...
<html>
  <head>
	...
	<script src="../js/myjavatipopersona.js"></script>
  </head>
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
				...
				<li class="active"><a href="<?php echo $CFG->wwwroot;?>/registros/tipopersona"><i class="fa fa-circle-o"></i> Tipo Cliente / Proveedor</a></li>
   ...
   <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Mantenimiento Tipo de Persona
          </h1>
          <ol class="breadcrumb">
            <li><a href="."><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li class="active">Mantenimiento Tipo de Persona</li>
          </ol>
        </section>
    ...
    <table border="0" align="center" class="table table-striped table-condensed table-hover">
    	<tr>
        	<td width="555"><input type="text" class="form-control" placeholder="Busca un tipo de persona por: Nombre" id="busca"/></td>
            <td width="100"><button id="nuevo-tipopersona" class="btn btn-primary form-control">Nuevo Registro</button></td>
        </tr>
    </table>
    </section>
...
function valida(e) {
    ...
    <div class="modal fade" id="registra-tipopersona" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>Registra o Edita un Tipo Persona</b></h4>
            </div>
            ...
            <div class="modal-body">
				<table border="0" width="100%">
                	...
                	<tr>
                    	<td>Tipo Persona: </td>
                        <td><input type="text" required="required" name="tipopersona" id="tipopersona" maxlength="100" class="form-control" onKeyPress="return valida(event)"/></td>
                    </tr>
                    <tr>
                    	<td colspan="2">
                        	<div id="mensaje"></div>
