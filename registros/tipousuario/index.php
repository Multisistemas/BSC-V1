...
<html>
  <head>
	...
	<script src="../js/myjavatipousuario.js"></script>
  </head>
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
                ...
                <li class="active"><a href="<?php echo $CFG->wwwroot;?>/registros/tipousuario"><i class="fa fa-circle-o"></i> Tipo Usuarios</a></li>
   ...
   <!-- Content Wrapper. Contains page content -->
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Mantenimiento Tipo de Usuario</li>
          </ol>
        </section>
    ...
    <table border="0" align="center" class="table table-striped table-condensed table-hover">
    	<tr>
        	<td width="555"><input type="text" class="form-control" placeholder="Busca un tipo usuario por: Nombre" id="busca"/></td>
            <td width="100"><button id="nuevo-tipousuario" class="btn btn-primary form-control">Nuevo Registro</button></td>
        </tr>
    </table>
    </section>
...
function valida(e) {
    ...
    <div class="modal fade" id="registra-tipousuario" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>Registra o Edita un Tipo Usuario</b></h4>
            </div>
            <form id="formulario" class="formulario" onSubmit="return agregaRegistro();">
            <div class="modal-body">
				<table border="0" width="100%">
               		 <tr>
                        <td colspan="2"><input type="text" required="required" readonly="readonly" id="id" name="id" readonly="readonly" style="visibility:hidden; height:1px;"/><input type="text" required="required" readonly="readonly" id="pro" name="pro" style="visibility:hidden; height:1px;"/></td>
                    </tr>
                	<tr>
                    	<td>Tipo Usuario: </td>
                        <td><input type="text" required="required" name="tipou" id="tipou" maxlength="100" class="form-control" onKeyPress="return valida(event)"/></td>
                    </tr>
                    <tr>
                    	<td colspan="2">
                        	<div id="mensaje"></div>
