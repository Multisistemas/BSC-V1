...
<html>
  <head>
	...
	<script src="../js/myjavausuario.js"></script>
  </head>
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
                ...
                <li class="active"><a href="<?php echo $CFG->wwwroot;?>/registros/usuario"><i class="fa fa-circle-o"></i> Usuarios</a></li>
   ...
   <!-- Content Wrapper. Contains page content -->
    ...
    <table border="0" align="center" class="table table-striped table-condensed table-hover">
    	<tr>
        	<td width="555"><input type="text" class="form-control" placeholder="Busca un usuario por: Nombre" id="busca"/></td>
            <td width="100"><button id="nuevo-usuario" class="btn btn-primary form-control">Nuevo Registro</button></td>
        </tr>
    </table>
    </section>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
				<table border="0" width="100%">
                	...
                	<tr>
                    	<td>Nombres: </td>
                        <td><input type="text" required="required" name="nombres" id="nombres" maxlength="100" class="form-control" onKeyPress="return valida(event)"/>								</td>
                    </tr>
					<tr>
                    	<td>Apellidos: </td>
                        <td><input type="text" required="required" name="apellidos" id="apellidos" maxlength="100" class="form-control" onKeyPress="return valida(event)"/>								</td>
                    </tr>
					                	<tr>
                    	<td>E-mail: </td>
                        <td><input type="email" required="required" name="email" id="email" maxlength="100" class="form-control"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Clave: </td>
                        <td><input type="password" required="required" name="clave" id="clave" maxlength="100" class="form-control"/>								</td>
					<tr>
                    	<td>Tipo Usuario: </td>
                        <td><?php llenarcombo('tipousuario','idtipousuario, tipousuario',' ORDER BY 2', $idtipousuario, '','idtipousuario'); ?>								</td>
                    </tr>
					<tr>
                    	<td>Area: </td>
					...
					<tr>
                    	<td>Empresa: </td>
                        <td><?php llenarcombo('empresa','idempresa, razonsocial',' where idempresa='.$_SESSION['id_empresa'].' ORDER BY 2', $idempresa, '','idempresa'); ?>								</td>
                    </tr>
                    <tr>
                    	<td colspan="2">
                        	<div id="mensaje"></div>
