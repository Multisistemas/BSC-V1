          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
				<table border="0" width="100%">
					...
					<tr>
                    	<td>DUI: </td>
                        <td><input type="text" required="required" name="dui" id="dui" maxlength="11" class="form-control" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;"/>								</td>
                    </tr>
                	<tr>
                    	<td>Nombres: </td>
