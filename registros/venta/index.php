...
overflow: hidden;
	...
	<script src="../js/myjavaventa.js"></script>
  </head>
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
              ...
              <ul class="treeview-menu">
			  <?php if($_SESSION['id_area']==5) { ?>
                <li class="active"><a href="<?php echo $CFG->wwwroot;?>/registros/venta"><i class="fa fa-circle-o"></i> Venta por Menor</a></li>
