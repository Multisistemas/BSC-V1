...
$iduser=$_SESSION['id_usu'];
    ...
    $nroProductos = mysqli_num_rows(mysqli_query($DB, "select t.idproducto,p.producto,t.cantidad,p.precioventau from temporal t,producto p where t.idproducto=p.idproducto and t.idusuario='$iduser'"));
    $nroLotes = 10;
