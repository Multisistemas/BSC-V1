<?php
	...
	$consulta = "SELECT categoria,sum(cantidad) as cantidad,month(fecha) as mes FROM documento_venta d,detalle_documentoventa dv , producto p,categoria c where d.iddocumento=dv.iddocumento and p.idcategoria=c.idcategoria and dv.idproducto=p.idproducto and idempresa='$idempresa' group by p.idcategoria";
