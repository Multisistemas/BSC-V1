          ...
          <ul class="sidebar-menu">
			...
			<li class="treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
				...
				<li class="active"><a href="<?php echo $CFG->wwwroot;?>/registros/objetivos"><i class="fa fa-circle-o"></i> Objetivos</a></li>
...
?>
   <!-- Content Wrapper. Contains page content -->
	...
	?>
		...
		<!-- Inicio Formulario -->
<div class="table-responsive mailbox-messages"><?php include('objetivos.php');?></div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
				<table border="0" width="100%">
                	...
                	<tr>
                    	<td>Tipo Usuario: </td>
                        <td><input type="text" required="required" name="tipou" id="tipou" maxlength="100" class="form-control"/></td>
                    </tr>
                    <tr>
                    	<td colspan="2">
                        	<div id="mensaje"></div>
