...
$idempresa = $_SESSION['id_empresa'];
    ...
    $nroProductos = mysql_num_rows(mysql_query("SELECT * FROM persona where idtipopersona='1' and idempresa='$idempresa'"));
    $nroLotes = 15;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysql_query("SELECT * FROM persona where idtipopersona='1' and idempresa='$idempresa' LIMIT $limit, $nroLotes ");
