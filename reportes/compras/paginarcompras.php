...
$idempresa=$_SESSION['id_empresa'];
    ...
    $nroProductos = mysql_num_rows(mysql_query("SELECT * FROM documento_compra dv,persona p WHERE dv.idproveedor=p.idpersona and dv.idempresa='$idempresa'"));
    $nroLotes = 80;
    ...
    if($paginaActual < $nroPaginas){
  	...
  	$registro = mysql_query("SELECT * FROM documento_compra dv,persona p WHERE dv.idproveedor=p.idpersona and dv.idempresa='$idempresa' LIMIT $limit, $nroLotes ");
