...
$registro = mysqli_query($link, "SELECT * FROM producto p,categoria c WHERE p.idcategoria=c.idcategoria and p.idempresa='$idempresa' and producto like '%$dato%' limit 500");
