...
<html>
  <head>
	...
	<script src="../js/myjavakardex.js"></script>
  </head>
  <body class="hold-transition skin-blue sidebar-mini">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
				...
				<li class="active"><a href="<?php echo $CFG->wwwroot;?>/reportes/kardex"><i class="fa fa-circle-o"></i> Ver Kardex</a></li>
				<?php } else {if($_SESSION['id_area']==3){ ?>
				<li class="active"><a href="<?php echo $CFG->wwwroot;?>/reportes/kardex"><i class="fa fa-circle-o"></i> Ver Kardex</a></li>
				<?php } else { ?>
				<li><a href="<?php echo $CFG->wwwroot;?>/registros/venta"><i class="fa fa-circle-o"></i> Venta por Menor</a></li>
   ...
   <!-- Content Wrapper. Contains page content -->
    ...
    <div class="modal fade" id="ver-detalle" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-primary">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
              <h4 class="modal-title" id="myModalLabel"><b>Detalle Kardex</b></h4>
            </div>
			<br>
			<table>
			<tr>
			<td><input type="text" id="idpro" class="form-control" style="visibility:hidden; height:1px;"/></td>
			<!--<td>&nbsp;&nbsp;</td>
            <td><label>Hasta:&nbsp;&nbsp;</label></td>
            <td><input type="date" id="bd-hasta" class="form-control"/></td>
			<td>&nbsp;&nbsp;</td>-->
            <td width="200"><a target="_blank" href="javascript:reportePDF();" class="btn btn-primary">Exportar Busqueda a PDF</a>				</td></tr></table>
			<br>
            <div class="registros" id="agrega-detalle"></div>
          </div>
        </div>
      </div>
	  <!--Fin formulario-->
