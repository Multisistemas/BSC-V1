...
$idempresa=$_SESSION['id_empresa'];
	...
	while($registro2 = mysqli_fetch_array($registro)){
		$tabla = $tabla.'<tr>
				...
				<td><button onclick="javascript:verdetalle('.$registro2['idproducto'].');" class="btn btn-block btn-primary btn-ls"><i class="glyphicon glyphicon-eye-open"></i> Ver detalle</button></td>
				</tr>';
	}
