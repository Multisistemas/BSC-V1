...
$registro = mysqli_query($link, "SELECT * FROM producto p,categoria c where p.idcategoria=c.idcategoria and p.idempresa='$idempresa' and producto LIKE '%$dato%' ORDER BY p.idproducto ASC limit 15");
