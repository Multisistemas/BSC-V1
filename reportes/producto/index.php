        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
              ...
              <ul class="treeview-menu">
			  <?php if($_SESSION['id_area']==5) { ?>
                <li class="active"><a href="<?php echo $CFG->wwwroot;?>/reportes/producto"><i class="fa fa-circle-o"></i> Productos</a></li>
				...
				<table border="0" width="100%">
                	...
                	<tr>
                        ...
                        <td><input type="text" required="required" name="producto" id="producto" maxlength="100" class="form-control"/>								</td>
					                	...
					                	<tr>
                    	<td>Precio Compra: </td>
                        <td><input type="text" required="required" name="precioc" id="precioc" maxlength="50" class="form-control"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Precio Venta: </td>
                        <td><input type="text" required="required" name="preciov" id="preciov" maxlength="50" class="form-control"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Precio Venta Unitario: </td>
                        <td><input type="text" required="required" name="preciovu" id="preciovu" maxlength="50" class="form-control"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Stock: </td>
                        <td><input type="text" required="required" name="stock" id="stock" maxlength="50" class="form-control"/>								</td>
                    </tr>
					<tr>
                    	<td>Color: </td>
                        <td><input type="text" required="required" name="color" id="color" maxlength="50" class="form-control"/>								</td>
                    </tr>
					<tr>
                    	<td>Referencia: </td>
