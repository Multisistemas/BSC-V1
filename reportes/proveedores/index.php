<?php include_once("../../registros/Function.php");
  if ($_SESSION['id_usu']=="") {
          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
                ...
                <li class="active"><a href="<?php echo $CFG->wwwroot;?>/reportes/proveedores"><i class="fa fa-circle-o"></i> Proveedores</a></li>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
				<table border="0" width="100%">
                	...
                	<tr>
                    	<td>RUC: </td>
                        <td><input type="text" required="required" name="ruc" id="ruc" maxlength="100" class="form-control"/>								</td>
                    </tr>
					                	<tr>
                    	<td>Razon Social: </td>
                        ...
                        <td><input type="text" required="required" name="telefono" id="telefono" maxlength="100" class="form-control"/>								</td>
                    </tr>
					<tr>
                    	<td>Celular: </td>
                        <td><input type="text" required="required" name="celular" id="celular" maxlength="100" class="form-control"/>								</td>
                    </tr>
					<tr>
                    	<td>E-mail: </td>
