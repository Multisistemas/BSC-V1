...
$registro = mysql_query("SELECT * FROM documento_venta dv,persona p WHERE dv.idcliente=p.idpersona and dv.idempresa='$idempresa' and fecha BETWEEN '$desde' AND '$hasta' ORDER BY iddocumento ASC limit 500");
