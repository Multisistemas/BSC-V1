          ...
          <ul class="sidebar-menu">
			...
			<li class="active treeview">
			  ...
			  <?php if($_SESSION['id_area']==5) { ?>
				...
				<li class="active"><a href="<?php echo $CFG->wwwroot;?>/reportes/ventas"><i class="fa fa-circle-o"></i> Ventas</a></li>
        ...
        <div class="modal-primary">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="myModalLabel"><b>Detalle Venta</b></h4>
            </div>
